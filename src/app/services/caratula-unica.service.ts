...
export class CaratulaUnicaService {
    ...
    public cargarCaratulaUnica():Observable<any>{
      return this.httpClient.get(this.API_SERV+"cargarCaratulaUnica/",{params:{usuario:"Nestorm"}});
    }

    public  getCaratulaUnicaDirecciones(idCaratulaUnica: any):Observable<any>{
      return this.httpClient.get(this.API_SERV+"getCaratulaUnicaDirecciones/", { params: { idCaratulaUnica : idCaratulaUnica } });
    }
    ...
    public  getMunicipios(idDepto: any):Observable<any>{
      debugger
      return this.httpClient.get(this.API_SERV+"findMunicipioByIdDepartamento/", { params: { idDepartamento: idDepto } });
    }
